...
\begin{itemize}
    ...
    \item \textbf{Contenido de la tabla \texttt{parcela\_especie\_arbol}.} Cabe destacar que dicha tabla contiene unicamente los pies mayores registrados en el cuarto inventario forestal nacional pues debido a errores en la etiquetación de los árboles resulta imposible relacionar las observaciones entre inventarios. Se incluye porque permite relacionar la clase diamétrica y la altura de las especies inventariadas así como recoger los datos de volúmenes y carbono almacenado al nivel de árbol. Cabe destacar que las variables \texttt{CA} y \texttt{CR} aparecen documentadas en el IFN4 en toneladas en lugar de kilogramos. Esto se trata de un error que ha sido identificado en el desarrollo de esta base de datos y comunicado al equipo de gestión del IFN (los datos se encuentran recogidos en kilogramos).
